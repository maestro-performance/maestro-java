...
class SerializationUtils {
    ...
    public static Test unpackTest(final MessageUnpacker unpacker) throws IOException {
        ...
        return new Test(testNumber, testIteration, testName, scriptName);
    }

    public static void packTest(final MessageBufferPacker packer, final Test test) throws IOException {
