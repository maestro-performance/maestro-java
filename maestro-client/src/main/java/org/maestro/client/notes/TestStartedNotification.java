...
public class TestStartedNotification extends MaestroNotification {
    private Test test;
    private String message;

    public TestStartedNotification() {
        super(MaestroCommand.MAESTRO_NOTE_NOTIFY_TEST_STARTED);
    }
    ...
    public String toString() {
        return "TestStartedNotification{" +
                "test=" + test +
                ", message='" + message + '\'' +
                "} " + super.toString();
    }
