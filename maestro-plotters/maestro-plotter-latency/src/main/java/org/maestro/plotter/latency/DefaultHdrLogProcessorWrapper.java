...
public class DefaultHdrLogProcessorWrapper implements HdrLogProcessorWrapper {
    private final double unitRatio;

    public DefaultHdrLogProcessorWrapper() {
        this(1.0);
    }

    public DefaultHdrLogProcessorWrapper(double unitRatio) {
