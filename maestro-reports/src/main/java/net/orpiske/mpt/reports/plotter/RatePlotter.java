...
public class RatePlotter implements Plotter {
    ...
    private FilteredRateDataProcessor rateDataProcessor = new FilteredRateDataProcessor(dateFilter);
    private RateReader rateReader = new FastRateReader(rateDataProcessor);
