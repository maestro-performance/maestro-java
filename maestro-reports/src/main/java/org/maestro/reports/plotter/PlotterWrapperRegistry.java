...
public final class PlotterWrapperRegistry {
    ...
    public PlotterWrapperRegistry() {
        ...
        registry.put(HdrHistogramReportFile.class, new HdrPlotterWrapper());
        registry.put(InspectorReportFile.class, new InspectorPlotterWrapper());
    }


    public PlotterWrapper getWrapper(Class<?> clazz) {
