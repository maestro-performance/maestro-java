    ...
    public void insert(final Report report) {
        runEmptyInsert(
                "insert into report(test_id, test_number, test_name, test_script, test_host, test_host_role, " +
                        "test_result, location, aggregated, test_description, test_comments) values(:testId, " +
                        ":testNumber, :testName, :testScript, :testHost, :testHostRole, :testResult, :location, " +
                        ":aggregated, :testDescription, :testComments)", report);
    }
