...
public class MiniReceivingPeer {
    Thread thread;
    MaestroWorkerExecutor executor;


    public void start() throws Exception {
        Class<MaestroWorker> clazz = (Class<MaestroWorker>) Class.forName("net.orpiske.mpt.maestro.worker.jms.JMSReceiverWorker");

        executor = new MaestroWorkerExecutor("mqtt://localhost:1883", "receiver", "localhost",
