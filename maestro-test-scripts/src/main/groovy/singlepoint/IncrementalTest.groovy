...
@Grab(group='net.orpiske', module='maestro-common', version='1.2.6')
@Grab(group='net.orpiske', module='maestro-client', version='1.2.6')
@Grab(group='net.orpiske', module='maestro-tests', version='1.2.6')
@Grab(group='net.orpiske', module='maestro-reports', version='1.2.6')
