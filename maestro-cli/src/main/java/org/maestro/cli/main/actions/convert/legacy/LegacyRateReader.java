...
package org.maestro.cli.main.actions.convert.legacy;


import org.apache.commons.csv.CSVFormat;
import org.apache.commons.csv.CSVRecord;
import org.apache.commons.csv.QuoteMode;
import org.maestro.plotter.common.readers.CompressedReader;
 ...
 */
public class LegacyRateReader extends CompressedReader<RateData> {
    private static final Logger logger = LoggerFactory.getLogger(LegacyRateReader.class);
    private final RateDataProcessor processor;

    public LegacyRateReader(final RateDataProcessor processor) {
